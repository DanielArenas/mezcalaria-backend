...
RSpec.describe SponsoresController, type: :controller do
  ...
  # SponsoresController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET #index" do
    it "assigns all sponsores as @sponsores" do
      sponsor = Sponsor.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:sponsores)).to eq([sponsor])
    end
  end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the sponsores list" do
      sponsor = Sponsor.create! valid_attributes
      delete :destroy, {:id => sponsor.to_param}, valid_session
      expect(response).to redirect_to(sponsores_url)
    end
  end
