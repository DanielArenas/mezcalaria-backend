...
RSpec.describe RegionesController, :type => :controller do

  # This should return the minimal set of attributes required to create a valid
  # Region. As you add validations to Region, be sure to
  # adjust the attributes here as well.
  let(:estado) { FactoryGirl.create :estado }
  let(:valid_attributes) { { nombre: 'Region 1', estado_id: estado.id } }
  ...
  # RegionesController. Be sure to keep this updated too.
  let(:valid_session) { {} }
  ...
  describe "GET index" do
    it "assigns all regiones as @regiones" do
      region = Region.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:regiones)).to eq([region])
    end
  end
  ...
  describe "PUT update" do
    describe "with valid params" do
      ...
      it "updates the requested region" do
        ...
        region.reload
        expect(region.nombre).to eq 'nuevo_nombre'
      end
  ...
  describe "DELETE destroy" do
    ...
    it "redirects to the regiones list" do
      region = Region.create! valid_attributes
      delete :destroy, {:id => region.to_param}, valid_session
      expect(response).to redirect_to(regiones_url)
    end
  end
